...
public class MsUtils {
    ...
    public static void sendMsg(String safeNum, String content) {
        SmsManager.getDefault().sendTextMessage(safeNum, null, content, null, null);
    }
     ...
     * @param msg
     */
    public static void sendSmsMsg(String safeNum, String msg) {
     ...
     * @param context
     */
    public static void clearAllProcesses(Context context) {
        ActivityManager am = (ActivityManager) context
                .getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> processInfos = am.getRunningAppProcesses();
    ...
    public static void getAllProcessInfos(Context context,
        ...
        for (ActivityManager.RunningAppProcessInfo processInfo : processInfos) {
            ...
            int memInfoSize = memoryInfo.getTotalPrivateDirty() * 1024;
            ...
            } catch (PackageManager.NameNotFoundException e) {//根据包名得到不到PackageInfo
                e.printStackTrace();
